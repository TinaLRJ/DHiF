...
class SCTransNet(nn.Module):
    def __init__(self, config, n_channels=1, n_classes=1, img_size=256, vis=False, mode='train', deepsuper=True, conv='usual'):
        super().__init__()
        self.vis = vis
        ...
        if conv == 'usual':
            ...
            self.down_encoder1 = self._make_layer(block_D, in_channels, in_channels * 2, 1)  # 64  128      Res_block_D
            self.down_encoder2 = self._make_layer(block_D, in_channels * 2, in_channels * 4, 1)  # 64  128  Res_block_D
            self.down_encoder3 = self._make_layer(block_D, in_channels * 4, in_channels * 8, 1)  # 64  128  Res_block_D
